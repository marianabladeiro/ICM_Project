...
public class TimePicker extends FrameLayout {
    ...
    public TimePicker(Context context, AttributeSet attrs, int defStyle) {
        ...
        inflater.inflate(R.layout.fragment_timer,
     ...
     * @return The current minute.
     */
    public Integer getS() { return mCurrentSeconds;}


    /**
     * Set the current second (0-59).
     */
    public void setS(Integer currentSecond) {
    ...
    private void onTimeChanged() {
        mOnTimeChangedListener.onTimeChanged(this, getCurrentHour(), getCurrentMinute(), getS());
    }
